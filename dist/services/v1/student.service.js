...
var StudentService = /** @class */ (function () {
    ...
    StudentService.prototype.getStudentList = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, student_schema_1.Student.find()];
                    case 1:
                        studentList = _a.sent();
    ...
    StudentService.prototype.getStudentDetail = function (studentId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, student_schema_1.Student.findById(studentId)];
                    case 1:
    ...
    StudentService.prototype.createStudent = function (studentRequest) {
        var student = new student_schema_1.Student(studentRequest);
